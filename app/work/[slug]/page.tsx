...
export default function WorkDetail({ params }: { params: { slug: string } }) {
  ...
  return <article className="pt-32">
    ...
    {project.cover?.kind === "image" && <Container className="mt-16"><div className="relative aspect-[16/9] overflow-hidden rounded-3xl border border-steel-400/25"><ImageAsset item={project.cover} sizes="100vw" priority /></div></Container>}
