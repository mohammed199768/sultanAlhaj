...
export const profile = {
  ...
  primaryTitle: "Digital Marketing Manager | Branding Specialist",
  extendedTitle: "Senior Marketing Specialist | Digital Strategist | Content Architect",
  positioning:
  ...
  about:
    "Sultan is a strategic and creative marketing professional with over 5 years of experience developing and executing integrated marketing campaigns across medical, retail, F&B, sports, and real estate sectors. He specializes in social media strategy, content development, brand building, and performance optimization. He is known for launching successful community activations, managing high-ROI campaigns, and creating culturally engaging Arabic/English content tailored for Jordanian and Saudi markets. He uses data insights to drive results across platforms like Meta, Google, Snapchat, and TikTok.",
